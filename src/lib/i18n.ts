...
const dict: Record<Locale, Record<string, string>> = {
	zh: {
		...
		'coverage.ok': '倍率合适',
		'coverage.too_small': '倍率偏低',
		'coverage.too_large': '倍率偏高',
		'misc.projectionDiagonalLabel': '投影对角线 = {d} mm',
		'tips.coverageEval': '根据覆盖比例评估接口匹配：>90% 判定倍率偏低；<50% 判定倍率偏高；否则判定倍率合适。',
	...
	en: {
		...
		'coverage.ok': 'Mag Optimal',
		'coverage.too_small': 'Mag too Low',
		'coverage.too_large': 'Mag too High',
		'misc.projectionDiagonalLabel': 'Proj. diagonal = {d} mm',
		'tips.coverageEval': 'Evaluate C-mount match by coverage: >90% → Mag too Low; <50% → Mag too High; otherwise Mag Optimal.',
	...
	de: {
		...
		'coverage.ok': 'Vergrößerung optimal',
		'coverage.too_small': 'Vergrößerung zu niedrig',
		'coverage.too_large': 'Vergrößerung zu hoch',
		'misc.projectionDiagonalLabel': 'Proj.-Diagonale = {d} mm',
		'tips.coverageEval': 'Adapter-Passung anhand Abdeckungsgrad: >90% → Vergrößerung zu niedrig; <50% → Vergrößerung zu hoch; sonst optimal.',
